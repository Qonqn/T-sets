...
priority_queue<TrajectorySimilarity> Top_k_similar_trajectory_search(shared_ptr<ZRedisConnection> con,string traj_str,int k){
    ...
    vector<pair<double,double>> query_traj=split_trajectory_points(traj_str);
    int initial_index=space_index(1,query_traj,120.487,30.999,121.809,31.477);
    string initial_indexStr=to_string(initial_index);
    int index=0;
    int positioncode=0;
    if(initial_indexStr[0]!='2'){
...
int main(){
    ...
    set<string> tb_simtraj=Tbsimilar_trajectory_search(con,"121.348,31.389;121.347,31.392;121.348,31.389;121.349,31.390;121.350,31.390;121.351,31.390;121.351,31.391;121.352,31.391;121.353,31.391;121.353,31.394;121.354,31.391;121.355,31.391;121.356,31.389;121.356,31.390;121.356,31.391;121.357,31.388;121.357,31.389;121.357,31.388",0.05);
